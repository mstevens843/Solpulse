const formatPost = (post) => ({
    ...
    profilePicture: post.isRetweet && post.originalPost ? post.originalPost.user.profilePicture : post.user.profilePicture || "https://www.solpulse.net/uploads/default-avatar.png", // Show original profile for retweets

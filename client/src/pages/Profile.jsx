    ...
    const fetchProfile = useCallback(async () => {
        ...
        while (retries > 0) {
            try {
                ...
                setProfilePicture(user.profilePicture || "https://www.solpulse.net/uploads/default-avatar.png");
                setBio(user.bio || "");
    ...
    const handleProfilePictureUpdate = async (file) => {
        if (!file) {
            try {
                ...
                setUser((prevUser) => ({
                    ...prevUser,
                    profilePicture: "https://www.solpulse.net/uploads/default-avatar.png",
                }));
